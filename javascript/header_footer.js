...
class Footer extends HTMLElement {
    ...
    <section class="footer_top_section">
      <section class="footer_logo">
        <picture>
          ...
          <a href="#"
            ><img
              src="./homePage_image/footerlogo.webp"
              alt="Pizza Hut Logo"
              width="70%"
          /></a>
        </picture>
  ...
  <section class="input1">
    <div>
      ...
      <input type="email" name="mail" placeholder="example@email.com" id="email" required />
      <br />
    </div>
    <div>
      <label for="phone">Утас</label>
      <input type="text" name="phone" placeholder="+976 ########"  id="phone" required/>
      <br />
    </div>
  </section>
  ...
  <section class="input_text">
    <div>
      ...
      <textarea name="message" id="message" class="texting" required></textarea>
    </div>
    
    <button type="submit" id="feedbackBtn">илгээх</button>
  </section>
</form>
...
<ul id="dataArray"></ul>
    ...
    <section class="footer_bottom_section">
      <p>
        © 2023 Оожоо Эрхэмээ Тэмүүлэн ХХК. Зохиогчийн эрх хуулиар
        хамгаалагдсан Developed by <a href="#">Tavanbogd Cubix LLC </a>
      </p>
    </section>
  </footer>
    `;
...
{/* <div class="button" >
      <input type="submit" value="Илгээх" id="feedback"/>
    </div> */}